...
export const projects = [
  {
    title: "Lapr 1",
    description:
      "This repository contains relevant didactic artifacts for the integrative project to be developed in the first semester of the 2022-2023 academic year in the Bachelor's Degree in Engineering (LEI) at the Instituto Superior de Engenharia do Porto (ISEP).",
  ...
  },
  {
    title: "Lapr 3",
    description:
      "This repository contains relevant didactic artifacts for the integrative project to be developed in the first semester of the 2023-2024 academic year in the Bachelor's Degree in Computer Engineering (LEI) at the Instituto Superior de Engenharia do Porto (ISEP).",
  ...
  },
  {
    title: "HairDrop",
    description:
      "This project is a service designed to seamlessly connect users with hair salons, barbershops, and independent hairstylists, offering a modern, on-demand solution for hair care.",
...
export const organization = {
  ...
  logo: pureNimble,
  description:
    "PureNimble is a space where we share university projects and personal work that could be useful to others. Our team consists of students, and we aim to provide simple, practical resources based on what we’ve learned. We’re not trying to stand out, just offering what we’ve created in case it helps someone else.",
};
